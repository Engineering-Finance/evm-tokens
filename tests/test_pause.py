...
def test_transfer(mock):
    ...
    assert(mock.balanceOf(accounts[0]) == 1000*10**18)
    assert(mock.balanceOf(accounts[1]) == 0)
    mock.transfer(accounts[1], 100*10**18, {"from": accounts[0]})
    assert(mock.balanceOf(accounts[0]) == 900*10**18)
    assert(mock.balanceOf(accounts[1]) == 100*10**18)
...
def test_transferFrom(mock):
    ...
    mock.approve(accounts[1], 100*10**18, {"from": accounts[0]})
    assert(mock.allowance(accounts[0], accounts[1]) == 100*10**18)
    mock.transferFrom(accounts[0], accounts[2], 100*10**18, {"from": accounts[1]})
    assert(mock.balanceOf(accounts[0]) == 900*10**18)
    assert(mock.balanceOf(accounts[1]) == 0)
    assert(mock.balanceOf(accounts[2]) == 100*10**18)
...
def test_pause(mock):
    ...
    with reverts():
        mock.transfer(accounts[0], 100*10**18, {"from": accounts[1]})
    assert(mock.balanceOf(accounts[0]) == 900*10**18)
    assert(mock.balanceOf(accounts[1]) == 100*10**18)
